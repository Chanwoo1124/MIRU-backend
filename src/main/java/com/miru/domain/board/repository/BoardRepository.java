...
public interface BoardRepository extends JpaRepository<Board, Long> {
    ...
    /**
     * 제목 키워드 검색 - NOTICE 타입 최상단 고정 후 최신순 정렬
     */
    @Query("SELECT b FROM Board b WHERE b.title LIKE %:keyword% ORDER BY CASE WHEN b.type = 'NOTICE' THEN 0 ELSE 1 END ASC, b.createdAt DESC")
